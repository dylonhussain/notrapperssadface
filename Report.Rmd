...
```{r Specificity, echo = FALSE}
 ans = readRDS('ans.Rda')
```
Using the random forest model trained with Beta=.8 a Sensitivity of `r  round(ans$byClass[['Sensitivity']], digits = 3)` was achieved when it was applied to the test set. This is very close to the `r allstats[['sensitivity']][[1]]` 
